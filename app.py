...
.hero-tag {
    ...
    color: #0071e3; margin-bottom: 0.75rem;
}
.hero-title {
...
.sim-table th {
    ...
    padding: 0.75rem 1rem; border-bottom: 1px solid #e5e5e7;
    text-align: right;
}
.sim-table th:first-child { text-align: left; }
.sim-table td {
    padding: 0.85rem 1rem; border-bottom: 1px solid #f2f2f7;
...
.sim-table-wrap {
    ...
    border: 1px solid #e5e5e7; overflow: hidden; padding: 0.25rem 0;
}
.nav-label {
    font-size: 11px; font-weight: 600;
...
.stTabs [data-baseweb="tab-list"] {
    background: #f5f5f7; border-radius: 12px; padding: 4px; gap: 2px;
}
...
with st.sidebar:
    ...
    <div style="background:#f5f5f7;border-radius:12px;padding:1rem;margin-top:0.5rem;">
        ...
        <div style="font-size:22px;font-weight:600;color:#0071e3;letter-spacing:-0.03em;">
...
# ═════════════════════════════════════════════════════════════════════════════
    ...
    for sr in sim_rows:
        ...
        bold      = "font-weight:600;background:#f5f5f7;" if sr["delta"] == 0 else ""
        rows_html += f"""
        <tr style="{bold}">
            <td>{delta_str}</td>
            <td>{sr['spend']:,.0f} €</td>
